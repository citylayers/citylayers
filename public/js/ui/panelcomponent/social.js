...
const SOCIAL_LINKS = new Map([
   [SOCIAL.FB, "https://www.instagram.com/layered.city/"],
   [SOCIAL.IG, "https://www.instagram.com/layered.city/"],
   [SOCIAL.YT, "/"],
   [SOCIAL.IN, "https://www.linkedin.com/company/layered-city/"],
   [SOCIAL.TW, "/"],
   [SOCIAL.GH, "https://github.com/STASYA00/citylayers/"],
    ...
    load() {
        Object.keys(SOCIAL).forEach(el => {
            let element = new ImageElement(
                this.makeId(),
                uuidv4(),
                new Illustration(`/images/social/${SOCIAL[el]}`, SOCIAL_LINKS.get(SOCIAL[el])),
                "social"
            );
            element.initiate();
            element.load();
